...
l1.insertar(2, 66)
print("Elementos:", list(l1))

# Probando eliminar
eliminado = l1.eliminar(1)
print(f"Elemento eliminado en posición 1: {eliminado}")
print("Elementos después de eliminar:", list(l1))

# Probando buscar
posicion = l1.buscar(66)
print(f"Posición del 66: {posicion}")
posicion = l1.buscar(99)
print(f"Posición del 99: {posicion}")
